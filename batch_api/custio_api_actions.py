...
class ModifyCustomer(BatchAPIAction):
    ...
    def __init__(self, **kwargs):
        ...
        **kwargs:
        ...
        uri_values:  Customer IO id value to pass into URL
        json: json payload of the request. Can be empty
        """
...
class CreateExport(BatchAPIAction):
    ...
    def __init__(self, filters, **kwargs):
        ...
        Parameters
        ----------
        :param filters: Required json dictionary containing filters for an export. Documentation found here: https://customer.io/docs/api/#operation/exportPeopleData
        Example:
        filters = {
            "filters": {
                "attribute": {
