...
class ModifyCustomer(BatchAPIAction):
    ...
    def __init__(self, **kwargs):
        ...
        headers: Headers passed as dict, generated by connection object creation
        request_dict_list: List of dictionaries containing request payload. Use
        uri_parameter_names: List of strings to pipe values from dict to URI params
        uri_param_list_remove_from_json: List of strings noting members of request dict to remove from json payload
        """
